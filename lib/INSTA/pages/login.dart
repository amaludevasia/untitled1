...
import 'package:flutter/material.dart';
import 'package:untitled1/INSTA/pages/homescren.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _login() {
    if (_userId.text.isEmpty) {
      ...
      //_showEmptyDialog("login not valid something");

       Navigator.push(context, MaterialPageRoute(builder: (context)=>CameraInsta()));
    }
  }
